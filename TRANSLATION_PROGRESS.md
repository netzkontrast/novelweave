...
This file tracks the translation progress of the documentation and templates.

## `docs` directory
- [ ] `docs/agent-skills-developer-guide.md`
- [ ] `docs/novelweave-agent-skills-marketplace-prd-v0.15.md`
- [ ] `docs/novelweave-agent-skills-prd-v0.14.md`
- [ ] `docs/novelweave-agent-skills-prd.md`
- [ ] `docs/writing-skills-best-practices.md`

## `templates` directory
- [x] `templates/novel-commands/_COMMON_INSTRUCTIONS.md`
- [x] `templates/novel-commands/analyze.md`
- [x] `templates/novel-commands/clarify.md`
- [x] `templates/novel-commands/constitution.md`
- [x] `templates/novel-commands/plan.md`
- [x] `templates/novel-commands/relations.md`
- [x] `templates/novel-commands/specify.md`
- [x] `templates/novel-commands/tasks.md`
- [x] `templates/novel-commands/timeline.md`
- [x] `templates/novel-commands/track-init.md`
- [x] `templates/novel-commands/track.md`
- [x] `templates/novel-commands/write.md`
- [x] `templates/novel-experts/core/character.md`
...
- [ ] `templates/skills/novelweave-workflow/SKILL.md`
